"""
Python Judge Service - Code Execution and Evaluation Engine
Port: 5000

This judge executes Python code against predefined test cases.
"""
...
def run_all_test_cases(code: str):
    ...
    temp_dir = tempfile.mkdtemp(prefix="judge_python_")
