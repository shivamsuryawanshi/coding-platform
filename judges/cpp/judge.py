"""
C++ Judge Service - Code Execution and Evaluation Engine
Port: 5002
...
# Configuration
TIMEOUT_SECONDS = 10  # Extra time for compilation
COMPILE_TIMEOUT = 10
...
def compile_code(temp_dir: str, source_file: str):
    ...
    try:
        ...
        return {
            ...
            "executable": executable if process.returncode == 0 else None,
            "stderr": process.stderr
        }
    except subprocess.TimeoutExpired:
        return {"success": False, "executable": None, "stderr": "Compilation timed out"}
    except Exception as e:
        return {"success": False, "executable": None, "stderr": str(e)}


def execute_code(executable: str, input_data: str, temp_dir: str):
...
def run_all_test_cases(code: str):
    ...
    temp_dir = tempfile.mkdtemp(prefix="judge_cpp_")
    ...
    try:
        ...
        for test_case in TEST_CASES:
            ...
            result = execute_code(executable, input_data, temp_dir)
